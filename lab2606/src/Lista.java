...
public class Lista<E> implements IMedicao{
	...
	public E remover() {
	 ...
	 public E obterPorIndice(int i) {
		...
		// Nunca deve chegar aqui se o índice estiver dentro do intervalo
		throw new IllegalStateException("Erro inesperado ao acessar índice " + i);
	}
